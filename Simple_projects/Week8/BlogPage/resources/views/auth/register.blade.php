                ...
                <div class="panel-body login-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label input-text-label">Name:</label>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label input-text-label">E-Mail Address:</label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label input-text-label">Password:</label>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label input-text-label">Confirm Password:</label>
