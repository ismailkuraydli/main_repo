...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <a href="{{route('blog',['blogId'=>$blogId])}}" class="link-blog">
                ...
                <div class="panel-body">
                    ...
                    @endif
                        ...
                        <div class="view-blog div-post paper-material">
                            ...
                            {!! Form::open(array('route'=> ['post',$post['id']],'class'=>'form-create')) !!}
                            
                            <div>
                            {!! Form::label('body', 'Add Comment:', ['class' => 'input-textarea-label']) !!}
                            {{$errors->first('body')}}
                            <br>
                            {!! Form::textarea('body', '',['class'=>'input-text input-comment']) !!}
                            </div>
                            

                            <div>
                            {!! Form::submit('Add Comment',['class' => 'form-button button-comment']) !!}
                            </div>
                            ...
                            @if(!$comments->isEmpty())
                                ...
                                <div class="comment-box">
                                    <p class="post-body">An OpenBooker: {{$comment['body']}}</p>
                                </div>
